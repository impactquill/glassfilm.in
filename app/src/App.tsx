...
// Product data
const products = [
  { id: 1, name: 'UV Shield Pro', category: 'Heat Control', image: '/product-uv-shield.jpg', rating: 4.8, reviews: 124, price: '₹120/sq ft', description: 'Block 99% harmful UV rays' },
  { id: 2, name: 'Frosted Elegance', category: 'Privacy', image: '/product-frosted.jpg', rating: 4.9, reviews: 89, price: '₹150/sq ft', description: 'Stylish opacity for offices' },
  { id: 3, name: 'Solar Silver', category: 'Solar', image: '/product-solar.jpg', rating: 4.7, reviews: 156, price: '₹180/sq ft', description: 'Reflective protection for south-facing windows' },
  { id: 4, name: 'Decorative Flora', category: 'Decorative', image: '/product-decorative.jpg', rating: 4.8, reviews: 67, price: '₹200/sq ft', description: 'Botanical patterns for homes' },
  { id: 5, name: 'One-Way Mirror', category: 'Privacy', image: '/product-mirror.jpg', rating: 4.9, reviews: 203, price: '₹220/sq ft', description: 'See out, not in' },
  { id: 6, name: 'Ceramic Heat Block', category: 'Heat Control', image: '/product-ceramic.jpg', rating: 4.8, reviews: 91, price: '₹250/sq ft', description: 'Advanced ceramic technology' },
  { id: 7, name: 'Gradient Fade', category: 'Decorative', image: '/product-gradient.jpg', rating: 4.6, reviews: 45, price: '₹180/sq ft', description: 'Modern ombre effect' },
  { id: 8, name: 'Custom Print Film', category: 'Decorative', image: '/product-custom.jpg', rating: 4.9, reviews: 34, price: '₹300/sq ft', description: 'Your design, your film' },
]
...
const faqs = [
  ...
  { question: 'What\'s the cost per square foot?', answer: 'Our films range from ₹120 to ₹300 per square foot depending on the type and features. We provide free quotes after measurement.' },
      ...
      <div className="bg-teal text-white py-2.5 px-4">
        <div className="container-custom flex flex-col sm:flex-row items-center justify-between gap-2 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span>Free Site Visit across 50+ cities | Installation within 48 hours</span>
          </div>
          <div className="flex items-center gap-4">
            <a href="tel:+91-98765-43210" className="flex items-center gap-1.5 hover:text-coral-200 transition-colors">
              <Phone className="w-4 h-4" />
              <span>+91-98765-43210</span>
            </a>
            <button 
              onClick={() => setIsBookingOpen(true)}
              className="bg-coral text-white px-4 py-1.5 rounded-full text-xs font-semibold hover:bg-coral-600 transition-colors"
            >
              Book Now
            </button>
          </div>
            ...
            <nav className="hidden lg:flex items-center gap-8">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-xl shadow-card opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <div className="p-2">
                    {['Heat Control', 'Privacy', 'Decorative', 'Solar'].map((item) => (
                      <a 
                        key={item}
                        href="#products" 
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-xl shadow-card opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <div className="p-2">
                    <a href="#wallpaper" className="block px-4 py-2.5 text-sm text-charcoal hover:bg-teal-50 hover:text-teal rounded-lg transition-colors">Custom Designs</a>
                    <a href="#wallpaper" className="block px-4 py-2.5 text-sm text-charcoal hover:bg-teal-50 hover:text-teal rounded-lg transition-colors">Room-wise Collection</a>
                    <a href="#wallpaper" className="block px-4 py-2.5 text-sm text-charcoal hover:bg-teal-50 hover:text-teal rounded-lg transition-colors">By Theme</a>
                  </div>
                </div>
              </div>
        ...
        {isMenuOpen && (
          <div className="lg:hidden bg-white border-t">
            <div className="container-custom py-4 space-y-4">
              ...
              <a href="#wallpaper" className="block py-2 text-charcoal font-medium">Wallpaper</a>
      ...
      <section className="sticky top-[72px] z-40 bg-white border-b shadow-sm">
        <div className="container-custom">
          <div className="flex items-center gap-2 overflow-x-auto py-4 no-scrollbar">
            {['All Products', 'Heat Control', 'Privacy', 'Decorative', 'Solar', 'Wallpaper'].map((category) => (
              <button
                key={category}
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-playfair font-bold text-charcoal mb-4">
              Explore Our Glass Film Collection
            </h2>
          ...
          {activeCategory === 'Wallpaper' ? (
            <div className="text-center py-16">
              <p className="text-slate text-lg">Explore our wallpaper collection in the section below</p>
              <a href="#wallpaper" className="inline-flex items-center gap-2 text-teal font-semibold mt-4 hover:underline">
                View Wallpaper <ArrowRight className="w-4 h-4" />
              </a>
            </div>
          ) : (
            ...
            <div className="bg-white p-4 rounded-2xl shadow-card">
              ...
              <div className="mt-4 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate">Solar Control Film • Mumbai</p>
                </div>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="flex items-center gap-4">
                <a href="tel:+91-98765-43210" className="flex items-center gap-2 text-teal font-semibold hover:underline">
              ...
              <form onSubmit={handleBookingSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {['Heat Control', 'Privacy', 'Decorative'].map((req) => (
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {['Heat Control Films', 'Privacy Films', 'Decorative Films', 'Solar Films', 'Custom Wallpaper'].map((item) => (
                  <li key={item}>
          ...
          {formSubmitted ? (
            ...
            <form onSubmit={handleBookingSubmit} className="space-y-4 mt-4">
              ...
              <div>
                ...
                <Input id="dialog-phone" type="tel" placeholder="+91 98765 43210" required className="mt-1.5" />
              </div>
              <div>
